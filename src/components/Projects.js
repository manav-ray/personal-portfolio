            ...
            :
                ...
                <Container style={{paddingTop: '5%', paddingBottom: '2%'}}>
                    ...
                    <Row style={{paddingTop: '5%'}}>
                        <img src={resumedb} alt="Sorting Mockup"/>
                    </Row>
                    ...
                    <Row style={{paddingTop: '5%'}}>
                        <img src={visualizer} alt="Sorting Mockup"/>
                    </Row>

                    <Row>
                        <Button onClick={() => window.open('https://manav-ray.github.io/shortest-path-finder/', '_blank')} style={{marginLeft: '5%', marginTop: '5%', width: '40%'}} className="btn">View It Here</Button>
                        <Button onClick={() => window.open('https://github.com/manav-ray/shortest-path-finder', '_blank')} style={{width: '40%', marginTop: '5%', marginLeft: '15px'}} className="btn">Github Repo</Button>
                    </Row>
                    ...
                    <Row style={{paddingTop: '5%'}}>
                        <img src={sorting} alt="Sorting Mockup"/>
                    </Row>

                    <Row>
                        <Button onClick={() => window.open('https://manav-ray.github.io/sorting-visualizer/', '_blank')} style={{marginLeft: '5%', marginTop: '5%', width: '40%'}} className="btn">View It Here</Button>
                        <Button onClick={() => window.open('https://github.com/manav-ray/sorting-visualizer', '_blank')} style={{width: '40%', marginTop: '5%', marginLeft: '15px'}} className="btn">Github Repo</Button>
                    </Row>
